...
public class AbstractDeviceListener implements DeviceListener {
	...
	@Override
	public int writeToFileMotionTimeSeries(File file) {
		return 0;
	}

	public void prepareFile(File file, int time, boolean time_series) {		
	}
	...
	@Override
	public void insertName(String name, File file) {
	}
}
